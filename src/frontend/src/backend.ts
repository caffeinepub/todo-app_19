...
export class Backend implements backendInterface {
    ...
    async addTodo(arg0: string): Promise<TodoId> {
        if (this.processError) {
            try {
    ...
    async clearCompleted(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearCompleted();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeAll(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeAll();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async delete_(arg0: TodoId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteAllTodos(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteAllTodos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveTodos(): Promise<Array<[TodoId, PersistedTodo]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveTodos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCompletedTodos(): Promise<Array<[TodoId, PersistedTodo]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedTodos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodos(): Promise<Array<[TodoId, PersistedTodo]>> {
        if (this.processError) {
            try {
    ...
    async toggle(arg0: TodoId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleAll(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleAll(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
